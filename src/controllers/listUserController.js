...
const listUserController = {
    index(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let userRoutes = yield db_listUser_1.default.find();
    ...
    post(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = req.body;
            const response = yield db_listUser_1.default.find();
            const user = response.filter((u) => {
                return u.nome === data.nome;
            });
            if (user === undefined || user.length === 0) {
                yield db_listUser_1.default.create(data);
                try {
    ...
    patch(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!!id && !!user && user.length > 0) {
                yield db_listUser_1.default.updateOne({ _id: id }, data);
                try {
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!!id && !!user && user.length > 0) {
                yield db_listUser_1.default.deleteOne({ _id: id });
                try {
